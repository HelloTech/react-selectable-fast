...
var SelectableGroup = (function(_Component) {
  ...
  function SelectableGroup(props) {
    ...
    _this.unregisterSelectable = function(selectableItem) {
      ...
      _this.deselectedItems.delete(selectableItem)
    }
    ...
    _this.mouseUp = function(event) {
      ...
      if (!_this.mouseMoved && (0, _nodeInRoot2.default)(e.target, _this.rootNode)) {
        ...
        _this.selectedItems = new Set([].concat(_toConsumableArray(_this.selectingItems)))
        ...
        _this.props.onSelectionFinish(
          [].concat(_toConsumableArray(_this.selectedItems)),
          [].concat(_toConsumableArray(_this.deselectedItems))
        )
      }

      _this.deselectedItems.clear()
  ...
  _createClass(SelectableGroup, [
      ...
      value: function handleClick(e, top, left) {
        ...
        if (
          ...
          this.props.onSelectionFinish(
            ...
            [].concat(_toConsumableArray(this.deselectedItems))
          )
    ...
    },
    {
      ...
      value: function render() {
        var inlineStyle = Object.assign({}, { position: 'relative' }, this.props.style)
